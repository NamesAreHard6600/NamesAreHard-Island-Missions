...
function Mission_NAH_Digging:IsPointValid(space)
...
function Mission_NAH_Digging:StartMission()
...
function Mission_NAH_Digging:UpdateMission()
  if self.DigSite then
    Board:MarkSpaceDesc(self.DigSite,"NAH_Dig_Site")
  end
end

function Mission_NAH_Digging:GetCompletedObjectives()
...
function Mission_NAH_Digging:UpdateObjectives()
